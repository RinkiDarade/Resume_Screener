...
def extract_skills_from_jd(jd_text: str) -> dict:
    ...
    {{
        ...
        "compulsory_programming_languages": "<comma-separated compulsory programming languages>",
        "programming_languages_compulsory": <true/false>,
        "programming_languages": "<comma-separated optional programming languages>",
        "cloud_services_compulsory": <true/false>,
        "must_cloud_services": "<comma-separated compulsory cloud services>",
        "cloud_services": "<comma-separated optional cloud services>",
        "databases_compulsory": <true/false>,
        "must_databases": "<comma-separated compulsory databases>",
        "databases": "<comma-separated optional databases>",
        "devops_compulsory": <true/false>,
        "must_devops": "<comma-separated compulsory devops tools>",
        "devops": "<comma-separated optional devops tools>",
        "big_data_compulsory": <true/false>,
        "must_big_data": "<comma-separated compulsory big data technologies>",
        "big_data": "<comma-separated optional big data technologies>",
        "frameworks_compulsory": <true/false>,
    ...
    response = client_evaluator.chat.completions.create(
        model="gpt-4.1",  
        messages=[
            {"role": "system", "content": "You are a helpful assistant that extracts job skills."},
